...
describe("Nano S", function () {
  test("Should return the correct transaction signature", async function () {
    const sim = new Zemu(models.nano_s.path);
    try {
      await sim.start({ ...defaultOptions, model: models.nano_s.name });
  ...
  test("Should return the correct public key for Nano S", async function () {
    const sim = new Zemu(models.nano_s.path);
    try {
  ...
  test("should display Contellation home screen correctly", async function () {
    const sim = new Zemu(models.nano_s.path);
    try {
      await sim.start({ ...defaultOptions, model: models.nano_s.name });
      await sim.navigateAndCompareSnapshots(
        ".",
        `${models.nano_s.prefix.toLowerCase()}-Constellation-Home-Screen`,
        []
      );
    } finally {
      await sim.close();
  ...
  test(
    ...
    async function () {
      ...
      try {
        ...
        await sim.navigateAndCompareSnapshots(
          ".",
          `${models.nano_s.prefix.toLowerCase()}-Settings-Screen`,
          []
        );
      } finally {
        await sim.close();
  ...
  test(
    ...
    async function () {
      ...
      try {
        ...
        await sim.navigateAndCompareSnapshots(
          ".",
          `${models.nano_s.prefix.toLowerCase()}-Blind-Signing-Disabled`,
          []
        );
      } finally {
        await sim.close();
  ...
  test(
    ...
    async function () {
      ...
      try {
        ...
        await sim.navigateAndCompareSnapshots(
          ".",
          `${models.nano_s.prefix.toLowerCase()}-Blind-Signing-Enabled`,
          []
        );
      } finally {
        await sim.close();
  ...
  test("Should display transaction signing flow review transactions screen correctly ", async function () {
    ...
    try {
      ...
      await sim.navigateAndCompareSnapshots(
        ".",
        `${models.nano_s.prefix.toLowerCase()}-Review-transaction`,
        []
      );
  ...
  test("Should display transaction signing flow from address screen correctly ", async function () {
    ...
    try {
      ...
      await sim.navigateAndCompareSnapshots(
        ".",
        `${models.nano_s.prefix.toLowerCase()}-From-Address`,
        []
      );
      await sim.clickRight();
      await sim.clickRight();
  ...
  test("Should display transaction signing flow to address screen correctly ", async function () {
    ...
    try {
      ...
      await sim.navigateAndCompareSnapshots(
        ".",
        `${models.nano_s.prefix.toLowerCase()}-To-Address`,
        []
      );
      await sim.clickRight();
      await sim.clickRight();
  ...
  test("Should display transaction signing flow amount screen correctly ", async function () {
    ...
    try {
      ...
      await sim.navigateAndCompareSnapshots(
        ".",
        `${models.nano_s.prefix.toLowerCase()}-Amount`,
        []
      );
      await sim.clickRight();
      await sim.clickRight();
  ...
  test("Should display transaction signing flow fee screen correctly ", async function () {
    ...
    try {
      ...
      await sim.navigateAndCompareSnapshots(
        ".",
        `${models.nano_s.prefix.toLowerCase()}-Fee`,
        []
      );
      await sim.clickRight();
      await sim.clickBoth();
  ...
  test("Should display transaction signing flow sign transaction screen correctly ", async function () {
    ...
    try {
      ...
      await sim.navigateAndCompareSnapshots(
        ".",
        `${models.nano_s.prefix.toLowerCase()}-Sign-Transaction`,
        []
      );
      await sim.clickBoth();
  ...
  test("Should display transaction signing flow Deny transaction screen correctly", async function () {
    ...
    try {
      ...
      await sim.navigateAndCompareSnapshots(
        ".",
        `${models.nano_s.prefix.toLowerCase()}-Deny-Transaction`,
        []
      );
      await sim.clickLeft();
      await sim.clickBoth();
  ...
  test("Should display message signing flow Review Message screen correctly", async function () {
    ...
    try {
      ...
      await sim.navigateAndCompareSnapshots(
        ".",
        `${models.nano_s.prefix.toLowerCase()}-Review-Message`,
        []
      );
  ...
  test("Should display message signing flow Warning Blind Signing screen correctly", async function () {
    ...
    try {
      ...
      await sim.navigateAndCompareSnapshots(
        ".",
        `${models.nano_s.prefix.toLowerCase()}-Warning-Blind-Signing`,
        []
      );
  ...
  test("Should display message signing flow Sign Message screen correctly", async function () {
    ...
    try {
      ...
      await sim.navigateAndCompareSnapshots(
        ".",
        `${models.nano_s.prefix.toLowerCase()}-Sign-Message`,
        []
      );
  ...
  test("Should display message signing flow Deny Message screen correctly", async function () {
    const sim = new Zemu(models.nano_s.path);
    try {
      await sim.start({ ...defaultOptions, model: models.nano_s.name });
      const transport = sim.getTransport();
      ...
      await sim.navigateAndCompareSnapshots(
        ".",
        `${models.nano_s.prefix.toLowerCase()}-Deny-Message`,
        []
      );
